...
XS_EUPXS(XS_DBD__SQLite_OPEN_READONLY); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_DBD__SQLite_OPEN_READONLY)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
...
XS_EUPXS(XS_DBD__SQLite_OPEN_READWRITE); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_DBD__SQLite_OPEN_READWRITE)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
...
XS_EUPXS(XS_DBD__SQLite_OPEN_CREATE); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_DBD__SQLite_OPEN_CREATE)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
...
XS_EUPXS(XS_DBD__SQLite_OPEN_NOMUTEX); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_DBD__SQLite_OPEN_NOMUTEX)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
...
XS_EUPXS(XS_DBD__SQLite_OPEN_FULLMUTEX); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_DBD__SQLite_OPEN_FULLMUTEX)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
...
XS_EUPXS(XS_DBD__SQLite_OPEN_SHAREDCACHE); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_DBD__SQLite_OPEN_SHAREDCACHE)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
...
XS_EUPXS(XS_DBD__SQLite_OPEN_PRIVATECACHE); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_DBD__SQLite_OPEN_PRIVATECACHE)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
...
XS_EUPXS(XS_DBD__SQLite_OPEN_URI); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_DBD__SQLite_OPEN_URI)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
...
XS_EXTERNAL(boot_DBD__SQLite)
{
...

    {
        ...
        (void)newXSproto_portable("DBD::SQLite::OPEN_READONLY", XS_DBD__SQLite_OPEN_READONLY, file, "");
        (void)newXSproto_portable("DBD::SQLite::OPEN_READWRITE", XS_DBD__SQLite_OPEN_READWRITE, file, "");
        (void)newXSproto_portable("DBD::SQLite::OPEN_CREATE", XS_DBD__SQLite_OPEN_CREATE, file, "");
        (void)newXSproto_portable("DBD::SQLite::OPEN_NOMUTEX", XS_DBD__SQLite_OPEN_NOMUTEX, file, "");
        (void)newXSproto_portable("DBD::SQLite::OPEN_FULLMUTEX", XS_DBD__SQLite_OPEN_FULLMUTEX, file, "");
        (void)newXSproto_portable("DBD::SQLite::OPEN_SHAREDCACHE", XS_DBD__SQLite_OPEN_SHAREDCACHE, file, "");
        (void)newXSproto_portable("DBD::SQLite::OPEN_PRIVATECACHE", XS_DBD__SQLite_OPEN_PRIVATECACHE, file, "");
        (void)newXSproto_portable("DBD::SQLite::OPEN_URI", XS_DBD__SQLite_OPEN_URI, file, "");
